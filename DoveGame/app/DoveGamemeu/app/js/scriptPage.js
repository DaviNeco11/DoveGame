...
function startProcess() {
    ...
    ZOHO.CREATOR.init()
        .then(function (data) {
            ...
            ZOHO.CREATOR.API.getAllRecords(config3).then(function (response) {
            ...
            ZOHO.CREATOR.API.getAllRecords(config).then(function (response) {
                ...
                for (var index in recordArr) {
                    ...
                    var number = recordArr[index].Number;
